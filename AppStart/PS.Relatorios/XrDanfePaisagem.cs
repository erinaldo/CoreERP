...
{
    public partial class XrDanfePaisagem : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XrDanfePaisagem(List<PS.Lib.DataField> Params)
        {
            InitializeComponent();
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            //Data Emissão, Saida e hora da Saida
        ...
        private void ReportFooter1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (dsXML.Tables["vol"] != null)
            {
                ...
                {
                    xrLabel127.Text = dsXML.Tables["vol"].Rows[0]["qVol"].ToString();
                }
        ...
        private void DetailReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            //xrLabel82.DataBindings.Add("Text", null, "OriON");
            ...
            xrLabel74.DataBindings.Add("Text", null, "vUnCom", "{0:n3}");
        ...
        //Busca as informações dos itens e carrega uma lista
        private void itens()
        {
            lista = new ArrayList();
            //doc.LoadXml(path);
        ...
        private void ReportHeader2_BeforePrint_1(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (dsXML.Tables["emit"] != null)
            {
                if (dsXML.Tables["emit"].Columns["xNome"] != null)
        ...
        private void XrDanfePaisagem_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            MarcaDagua();
        }
    }
