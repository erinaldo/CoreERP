...
{
    public partial class XrDacte : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public XrDacte(List<PS.Lib.DataField> Params)
        {
            InitializeComponent();
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            #region exped
            //Expedidor
            if (dsXML.Tables["exped"] != null)
            {
                if (dsXML.Tables["exped"].Columns["xNome"] != null)
                {
                    xrLabel91.Text = dsXML.Tables["exped"].Rows[0]["xNome"].ToString();
                }
                if (dsXML.Tables["exped"].Columns["CNPJ"] != null)
                {
                    xrLabel85.Text = string.Format(@"{0:00\.000\.000\/0000\-00}", Convert.ToUInt64(dsXML.Tables["exped"].Rows[0]["CNPJ"].ToString()));
                }
                if (dsXML.Tables["exped"].Columns["IE"] != null)
                {
                    xrLabel81.Text = dsXML.Tables["exped"].Rows[0]["IE"].ToString();
                }
                if (dsXML.Tables["exped"].Columns["fone"] != null)
                {
                    xrLabel78.Text = string.Format("{0:(##) ####-####}", Convert.ToUInt64(dsXML.Tables["exped"].Rows[0]["fone"].ToString()));
                }
            }
            #endregion
            #region enderExped
            ...
            #endregion
            #region receb
            if (dsXML.Tables["receb"] != null)
            {
                if (dsXML.Tables["receb"].Columns["xNome"] != null)
                {
                    xrLabel106.Text = dsXML.Tables["receb"].Rows[0]["xNome"].ToString();
                }
                if (dsXML.Tables["receb"].Columns["CNPJ"] != null)
                {
                    xrLabel100.Text = string.Format(@"{0:00\.000\.000\/0000\-00}", Convert.ToUInt64(dsXML.Tables["receb"].Rows[0]["CNPJ"].ToString()));
                }
                if (dsXML.Tables["receb"].Columns["IE"] != null)
                {
                    xrLabel96.Text = dsXML.Tables["receb"].Rows[0]["IE"].ToString();
                }
                if (dsXML.Tables["receb"].Columns["fone"] != null)
                {
                    xrLabel93.Text = string.Format("{0:(##) ####-####}", Convert.ToUInt64(dsXML.Tables["receb"].Rows[0]["fone"].ToString()));
                }
            }
            #endregion
            #region enderReceb
        ...
        private void PageFooter_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                xrLabel171.Text = dsXML.Tables["compl"].Rows[0]["xObs"].ToString();
            }
