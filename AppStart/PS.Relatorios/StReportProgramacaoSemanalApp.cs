...
{
    public partial class StReportProgramacaoSemanalApp : PS.Lib.WinForms.StaticReport.FrmBaseAppStaticReport
    {
        ...
        public StReportProgramacaoSemanalApp()
        {
            InitializeComponent();
            psTransportadora.PSPart = "PSPartTransportadora";
        ...
        public override void Execute()
        {
            ...
            this.Parameters.Add(new PS.Lib.DataField("TRANSPORTADORA", psTransportadora.Text));
            ...
            this.Report = new XrProgramacaoSemanal(this.Parameters);
...
//TRANSPORTADORA
                case "DT. ENTREGA":
                    return "GOPER.DATAENTREGA";
                case "PEDIDO":
                    return "GOPER.NUMERO";
                case "CLIENTE":
                    return "VCLIFOR.NOMEFANTASIA";
                case "COD. PRODUTO":
                    return "VPRODUTO.CODPRODUTO";
                case "QTD":
                    return "GOPERITEM.QUANTIDADE";
                case "TRANSPORTADORA":
                    return "VTRANSPORTADORA.NOME";
                default:
                    return string.Empty;
            }
        }
        private void StReportProgramacaoSemanalApp_Load(object sender, EventArgs e)
        {
            CarregaCombo();
