...
{
    public partial class StReportExtratoBancarioApp : PS.Lib.WinForms.StaticReport.FrmBaseAppStaticReport
    {
        ...
        public StReportExtratoBancarioApp()
        {
            InitializeComponent();
        }
        public override void Execute()
        {
            ...
            this.Parameters.Add(new PS.Lib.DataField("CONTACAIXA", psContaCaixa.Text));
            ...
            this.Report = new XrExtratoBancario(this.Parameters);
        ...
        private string getCampo(string nomeCampo)
        {
            ...
            {
                case "NUMERODOC":
                    return "FEXTRATO.NUMERODOCUMENTO";

                case "HISTORICO":
                    return "FEXTRATO.HISTORICO";
                default:
                    return string.Empty;
            }
        }
        private void StReportExtratoBancarioApp_Load(object sender, EventArgs e)
        {
            CarregaCombo();
