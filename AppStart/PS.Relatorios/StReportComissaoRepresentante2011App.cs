...
{
    public partial class StReportComissaoRepresentante2011App : PS.Lib.WinForms.StaticReport.FrmBaseAppStaticReport
    {
        ...
        public StReportComissaoRepresentante2011App()
        {
            InitializeComponent();
        ...
        public override void Execute()
        {
            ...
            this.Report = new XrComissaoRepresentante2011(this.Parameters);
        ...
        private void StReportComissaoRepresentante2011App_Load(object sender, EventArgs e)
        {
            CarregaCombo();
