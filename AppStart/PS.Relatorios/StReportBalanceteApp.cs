...
{
    public partial class StReportBalanceteApp : PS.Lib.WinForms.StaticReport.FrmBaseAppStaticReport
    {
        PS.Lib.Data.DBS dbs = new PS.Lib.Data.DBS();
        ListViewItem item = new ListViewItem();
        List<parametro> parametro = new List<parametro>();
        BindingSource bs = new BindingSource();
        public StReportBalanceteApp()
        {
            InitializeComponent();
        }
        public override void Execute()
        {
            ...
            this.Report = new XrBalancete(this.Parameters);
            PS.Lib.WinForms.Report.ReportDesignTool rp = new PS.Lib.WinForms.Report.ReportDesignTool(Report);
            rp.ShowPreviewDialog();
        }

        private void StReportBalanceteApp_Load(object sender, EventArgs e)
        {
            CarregaCombo();
