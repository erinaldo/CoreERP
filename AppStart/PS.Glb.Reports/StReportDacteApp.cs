...
{
    public partial class StReportDacteApp : PS.Lib.WinForms.StaticReport.FrmBaseAppStaticReport
    {
        private PS.Lib.Data.DBS dbs = new PS.Lib.Data.DBS();

        public StReportDacteApp()
        {
            InitializeComponent();
        }
        ...
        public override void Execute()
        {
            ...
            this.Report = new XrDactePaisagem(this.Parameters);
