    ...
    public partial class XrDanfePaisagem : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void ReportFooter1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (dsXML.Tables["vol"] != null)
            {
                ...
                {
                    xrLabel131.Text = string.Format("{0:n4}", Convert.ToDecimal(dsXML.Tables["vol"].Rows[0]["pesoL"].ToString().Replace(".", ",")));
                }
                if (dsXML.Tables["vol"].Columns["pesoB"] != null)
                {
                    xrLabel132.Text = string.Format("{0:n4}", Convert.ToDecimal(dsXML.Tables["vol"].Rows[0]["pesoB"].ToString().Replace(".", ",")));
                }
            }
        }
