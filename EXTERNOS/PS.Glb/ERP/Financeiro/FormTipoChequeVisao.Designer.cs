...
{
    partial class FormTipoChequeVisao
    {
        /// <summary>
        ...
        "SELECT *",
        "FROM FTIPOCHEQUE"};
            this.grid1.NomeGrid = "FTIPOCHEQUE";
            this.grid1.Size = new System.Drawing.Size(524, 364);
            ...
            this.Name = "FormTipoChequeVisao";
            this.Text = "Visão de Tipo de Cheque";
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormTipoChequeVisao_FormClosed);
            this.Load += new System.EventHandler(this.FormTipoChequeVisao_Load);
