namespace PS.Glb.ERP.Financeiro
{
    partial class FormChequeVisao
    {
        ...
        "SELECT",
        "FCHEQUE.*,",
        "( SELECT DESCRICAO FROM FCONTA WHERE CODEMPRESA = FCHEQUE.CODEMPRESA AND CODCONTA" +
            " = FCHEQUE.CODCONTA ) CONTA,",
        "CASE WHEN ( TIPOPAGREC = 0 ) THEN \'PAGAR\' ELSE \'RECEBER\' END TIPO",
        "",
        "FROM FCHEQUE",
        "",
        "WHERE CODEMPRESA = ?"};
            this.grid1.NomeGrid = "FCHEQUE";
            this.grid1.Size = new System.Drawing.Size(615, 433);
            ...
            // splitContainer1
            // 
            this.splitContainer1.Size = new System.Drawing.Size(615, 433);
            // 
            // FormChequeVisao
            // 
            ...
            this.Name = "FormChequeVisao";
            this.Text = "Visão de Cheque";
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormChequeVisao_FormClosed);
            this.Load += new System.EventHandler(this.FormChequeVisao_Load);
