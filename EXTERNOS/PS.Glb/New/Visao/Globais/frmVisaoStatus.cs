...
{
    public partial class frmVisaoStatus : Form
    {
        string tabela = "GSTATUS";
        public bool Visualizacao = true;

        public frmVisaoStatus(Form frmprin)
        {
            InitializeComponent();
        ...
        {
            Cadastros.Globais.frmStatus frm = new Cadastros.Globais.frmStatus();
            //frm.edita = false;
            frm.ShowDialog();
            carregaGrid();
        }
        ...
        private void edita()
        {
            ...
            frm.CodStatus = row1["CODSTATUS"].ToString();
        ...
        private void frmVisaoStatus_Load(object sender, EventArgs e)
        {
