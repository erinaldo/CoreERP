...
{
    public partial class frmVisaoTipoBairro : Form
    {
        public Form pai = null;
        public bool consulta = false;
        string tabela = "GTIPOBAIRRO";
        ...
        public string CodTipBairro;
        public string Nome;

        //Variaveis para NewLookup
        private NewLookup lookup;

        public frmVisaoTipoBairro(string _query, Form frmprin, string _CodMenu)
        {
            InitializeComponent();
            codMenu = _CodMenu;
        ...
        public frmVisaoTipoBairro(string _where, bool _consulta)
        {
            InitializeComponent();
            tabelasFilhas.Clear();
            query = _where;
        ...
        public frmVisaoTipoBairro(ref NewLookup lookup)
        {
            InitializeComponent();
        ...
        private void frmVisaoTipoBairro_Load(object sender, EventArgs e)
        {
        ...
        {
            DataTable dt = AppLib.Context.poolConnection.Get("Start").ExecQuery("SELECT * FROM GTIPOBAIRRO WHERE CODTIPOBAIRRO = ?", new object[] { dr["GTIPOBAIRRO.CODTIPOBAIRRO"] });
        ...
        private void Atualizar()
        {
            ...
            lookup.txtcodigo.Text = row1[tabela + ".CODTIPOBAIRRO"].ToString();
            lookup.ValorCodigoInterno = row1[tabela + ".CODTIPOBAIRRO"].ToString();
            this.Dispose();
        }
