...
{
    public partial class frmVinculoLancamento : Form
    {
        ...
        public frmVinculoLancamento(int codlanca)
        {
            InitializeComponent();
            CODLANCA = codlanca;
        ...
        private void frmVinculoLancamento_Load(object sender, EventArgs e)
        {
            // LIMPA AS GRIDS
