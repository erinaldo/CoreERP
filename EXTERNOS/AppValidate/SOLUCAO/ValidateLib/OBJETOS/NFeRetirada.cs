...
{
    [Serializable]
    public class NFeRetirada : ParamsBase
    {
        ...
        public void Save()
        {
            ...
            catch (Exception ex)
            {
                ...
                ValidateLib.Log.SalvarLog("NFeRetirada.Save", err);
                throw new Exception(err);
            }
        }

        public static NFeRetirada ReadByIDOutbox(params object[] parameters)
        {
            NFeRetirada _nfeentrega = new NFeRetirada();
